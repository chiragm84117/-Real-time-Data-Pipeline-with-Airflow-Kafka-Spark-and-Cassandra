...
class DagRunEditForm(DynamicForm):
    ...
    dag_id = StringField(lazy_gettext("dags Id"), validators=[ReadOnly()], widget=BS3TextFieldROWidget())
...
class TaskInstanceEditForm(DynamicForm):
    ...
    dag_id = StringField(
        lazy_gettext("dags Id"), validators=[InputRequired(), ReadOnly()], widget=BS3TextFieldROWidget()
    )
    task_id = StringField(
