...
class DagModel(Base):
    ...
    # The base directory used by dags Processor that parsed this dag.
    ...
    # dags owner links for DAGs view
    ...
    def get_paused_dag_ids(dag_ids: list[str], session: Session = NEW_SESSION) -> set[str]:
        """
        Given a list of dag_ids, get a set of Paused dags Ids.

        :param dag_ids: List of dags ids
        :param session: ORM Session
    ...
    def dags_needing_dagruns(cls, session: Session) -> tuple[Query, dict[str, tuple[datetime, datetime]]]:
        """
        Return (and lock) a list of dags objects that are due to create a new DagRun.
